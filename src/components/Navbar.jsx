...
function Navbar() {
    ...
    return (
        <div className="navbar w-full h-[10%] bg-black font-mono  md:px-10 text-md text-white">
            <div className="navbar-center">
                <div className="dropdown md:hidden" >
                    ...
                    {toggleHamburg && (<ul tabIndex={0} className="menu menu-sm dropdown-content mt-2 z-[1] p-4 shadow-xl bg-black rounded-box w-40">
                        <li><Link to="/">
                        ...
                        <li>
                            ...
                            <Link to="/contact">
                                <button onClick={() => { setToggleHamburg(!toggleHamburg) }}>Contact</button>
                            </Link></li>
                    </ul>)}
                </div>
