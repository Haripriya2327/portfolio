export default function Projects() {
	return (<>
	<div className='flex flex-col fixed h-full w-full justify-evenly overflow-y-scroll lg:overflow-hidden bg-black px-20 py-20'>
		<div className='flex flex-col h-[50%] justify-evenly  bg-black lg:flex-row pt-4 md:pt-4 md:py-4'>
			<div className="flex flex-col items-center border-gray-200 pb-10 px-20 ">
				...
				<h3 className="mb-1 text-xl font-medium  text-white">Click and Rent</h3>
			...
			<div className="flex flex-col items-center border-gray-200 pb-10 px-20">
				...
				<h3 className="mb-1 text-xl font-medium text-white">Weather Wise</h3>
		...
		<div className='flex flex-col  h-[50%] justify-evenly bg-black  lg:flex-row pt-4 md:pt-4 md:py-4'>
			<div className="flex flex-col items-center border-gray-200 pb-10 px-20">
				{/* <img className="mb-3 w-24 h-24 rounded-full shadow-lg" src={hariPic} alt="Hari image" /> */}
				<h3 className="mb-1 text-xl font-medium text-white">Uriyadi</h3>
			...
			<div className="flex flex-col items-center border-gray-200 pb-10 px-20">
				{/* <img className="mb-3 w-24 h-24 rounded-full shadow-lg" src={hariPic} alt="Hari image" /> */}
				<h3 className="mb-1 text-xl font-medium text-white">Rock Paper Scissors</h3>
